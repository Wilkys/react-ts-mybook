...
const Add: React.FC<AddProps> =({ loading, back, logout, add }) => {
  ...
  return(
    <Layout>
      <PageHeader 
        onBack={back}
        title={<div><FormOutlined /> Add Book</div>}
        ...
        <div className={styles.add}>
          <div className={styles.input_title}>Title
          ...
          <div className={styles.input_comment}>Comment
            <span className={styles.required}>*</span>
          </div>
          <div className={styles.input_area}>
          ...
          <div className={styles.input_author}>Author
            <span className={styles.required}>*</span>
          </div>
          <div>
          ...
          <div className={styles.input_url}>URL
            <span className={styles.required}>*</span>
          </div>
